...
mapFile_path = "./download_data/data/map/countries-10m_V31_6.json"
countriesCsv_path = "./download_data/extra-data/8_countries.csv"
...
def save_difference(not_in_map, not_in_temp):
    ...
    df = df.transpose()
    df.to_csv("./download_data/extra-data/13_difference.csv")

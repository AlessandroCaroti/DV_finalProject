...
log_file = "./maps_modification/log.txt"
map_directory = "./maps_modification"
...
# Se true il poligono che viene estratto viene anche rimosso dal set di poligoni in cui si
